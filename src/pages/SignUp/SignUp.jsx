      ...
      <AuthLyout>
        <div className=" w-4/6 md:w-2/6 mx-auto  pt-5 md:pt-5">
          ...
          <div className="">
            <form action="submit">
              <div>
                <p className="mt-16 md:mt-5 mb-8 md:max-w-[300px] leading-[25.82px] m-auto text-[26px] primary-font-family text-center font-bold">
                  Create your account
                </p>
                ...
                <p className="secondary-para mt-2 mb-1">Confirm password*</p>
                <div className="relative">
                  <input
                   className="border rounded-md outline-none w-full py-2 pl-2"
                    placeholder=""
